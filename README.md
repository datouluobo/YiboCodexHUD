...
<img src="assets/screenshots/hud-overlay.png" alt="YiboCodexHUD 在 Codex 窗口标题栏附近显示用量信息 / usage information near the Codex window title bar" width="780">

### 设置页 / Settings

<img src="assets/screenshots/settings.png" alt="YiboCodexHUD 设置页 / settings page" width="500">
